            ...
            <div className="flex flex-col space-y-3 pt-4">
              ...
              <div className="grid gap-5">
                <button
                  ...
                  className="flex w-full cursor-pointer gap- items-center justify-center space-x-2 rounded-full bg-orange-600 py-3.5 text-sm font-bold uppercase tracking-wider text-white transition duration-200 hover:bg-orange-700 active:scale-[0.99]"
                >
                ...
                <Link
                  to={"/"}
                  className="w-full cursor-pointer rounded-full border border-orange-600 bg-transparent py-3 text-sm font-bold uppercase text-center tracking-wider text-orange-500 transition duration-200 hover:bg-orange-600/10 active:scale-[0.99]"
                >
                  Keep Shopping
                </Link>
              </div>
